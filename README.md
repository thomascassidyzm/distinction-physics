...
- [The shared root — what the distinction thesis and Configuration Economics actually have in common](docs/canonical/shared-root.md). First articulation, 2026-09-06, forming, not ruled. The root stated once, what each branch adds, and five places they would disagree if pushed. Three rulings wanted, two ruled 2026-09-06.
- [The floor and the observer](docs/canonical/the-floor-and-the-observer.md). Ruled 2026-09-06. "Observer-independent" was doing two jobs: C1 dissolved *true from nowhere*, not *invariant across the observer class*, and the floor only ever needed the second.
