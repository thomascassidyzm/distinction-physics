...
export const concepts: Concept[] = [
  ...
  // ===========================================================================
  {
    ...
    name: 'Theorem 1.4: Effective Discreteness',
    category: 'theorem',
    epistemicStatus: 'derived',
    definitions: {
      brief: 'For an OLU whose registers couple to reservoirs no colder than T > 0 and whose free-energy expenditure over an observation epoch is bounded by E, every resolution act has cardinality N ≤ 2^(E / kT ln 2).',
      formal: 'Conditional and genuinely deductive given its ledger (§1.4): the Landauer floor and the third law are IMPORTED, and "access means readable record" plus registration faithfulness are INTERPRETED. A theorem of information thermodynamics about observers, on a stated model of what an observer is — not physics from first principles.',
      intuition: 'Arbitrarily fine distinctions require arbitrarily large energy, so every property is effectively discrete for every finite-energy observer.',
    },
    source: { module: 1, section: '1.4', blockId: 'thm-effective-discreteness' },
  ...
  },
  {
    ...
    name: 'Landauer\'s Principle (Post-Hoc Consistency)',
    category: 'physical',
    epistemicStatus: 'imported',
    definitions: {
      brief: 'Erasing one bit costs a minimum of kT ln(2) energy — established by Landauer in 1961 and confirmed experimentally.',
      formal: 'IMPORTED, not derived: Landauer grounds Axiom 1, never the other way round. §8.2 lists it as a post-hoc consistency demonstration, which validates nothing on its own. Confirmed independently by Bérut et al. (2012) and later experiments.',
      intuition: 'The framework agrees with Landauer because it was built to. The agreement is necessary for credibility, not evidence for the framework.',
    },
    source: { module: 8, section: '8.2' },
    tags: ['post-hoc-consistency', 'imported', 'thermodynamics'],
  ...
  },
  {
    ...
    epistemicStatus: 'established',
    definitions: {
      brief: 'Consciousness requires substantial continuous energy expenditure; a specific figure such as ~8W of the brain\'s ~20W is illustrative, not a measured partition.',
      formal: 'Type 2 (post-hoc consistency), resting on the conjectured consciousness model of Module 3. That the brain is metabolically expensive was documented independently; the framework supplies the WHY, not the finding.',
      intuition: 'Conscious experience is energetically expensive — a known fact the framework accommodates, not one it predicted.',
    },
    source: { module: 8, section: '8.2' },
  ...
  },
  {
    ...
    name: 'Measurement Problem Reframed',
    category: 'philosophical',
    epistemicStatus: 'interpreted',
    definitions: {
      brief: 'The measurement problem is reframed, not dissolved: measurement is read as distinction creation.',
      formal: 'Superposition is interpreted as undistinguished potential, measurement as distinction creation. WHY the wavefunction appears to collapse, and what physically happens during measurement, remain open. This is interpretive vocabulary [INTERPRETED], not a derivation of quantum mechanics [IMPORTED].',
      intuition: 'A different way of asking the question, not an answer to it.',
    },
    source: { module: 9, section: '9.2' },
    tags: ['quantum', 'reframing', 'measurement'],
  ...
  },
  {
    ...
    name: 'Two Axioms, One Structural Result',
    category: 'foundational',
    epistemicStatus: 'interpreted',
    definitions: {
      brief: 'From two axioms the framework genuinely derives one structural result — effective discreteness — and offers interpretive vocabulary for the rest.',
      formal: 'Three things are genuinely derived: discreteness, resolution limits, finitude (§1.11). Quantum mechanics, thermodynamics, mathematics and consciousness are read through the lens — consistent with, not derived from, the axioms.',
      intuition: 'Conceptual unification through common vocabulary, not derivation from first principles. The maths makes the position clearer; it does not make it bigger.',
    },
