 ...
 *
 * All formal concepts from the Distinction Physics treatise.
...
export const concepts: Concept[] = [
  ...
  },
  {
    ...
    definitions: {
      ...
      intuition: 'In our framework, this transforms: qualia ARE boundary maintenance from inside. There is no explanatory gap because there is no external "adding" of experience.',
    },
    source: { module: 3, section: '3.2' },
    tags: ['consciousness', 'philosophy', 'explanation'],
    related: ['qualia', 'consciousness'],
  },
  {
    id: 'integration',
    name: 'Integration (Φ)',
  ...
  },
  {
    ...
    definitions: {
      ...
      intuition: 'Distinction Physics agrees integration matters but adds self-reference requirement.',
    },
  ...
  },
  {
    ...
    definitions: {
      ...
      formal: 'Connects to Distinction Physics through energy constraints determining possible distinctions.',
  ...
  },
  {
    ...
    definitions: {
      ...
      formal: 'Connects to Distinction Physics through energy efficiency in distinction-making.',
