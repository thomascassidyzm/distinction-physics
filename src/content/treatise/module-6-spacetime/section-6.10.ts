  ...
  content: [
    ...
    },
    {
      ...
      items: [
        ...
        {
          content: '**Quantum/gravity incompatibility:** Both emerge from the same foundation—distinction-making under energy constraints—but manifest differently across scales',
        },
      ],
    },
    {
