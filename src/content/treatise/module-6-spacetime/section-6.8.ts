...
export const section6_8: Section = {
  ...
  content: [
    ...
    },
    {
      type: 'heading',
      level: 3,
      content: 'Reframing Cosmological Questions',
    },
    {
      type: 'paragraph',
      content:
    ...
    {
      type: 'table',
      id: 'tbl-cosmological-reframing',
      caption: 'Cosmological Questions Reframed',
      headers: ['Traditional Question', 'Distinction Framework Question'],
      rows: [
        [
          'What happened before the Big Bang?',
          'What was the state of the boundary landscape before distinction-making became possible?',
        ],
        [
          'Why is the universe expanding?',
          'Why is the boundary network growing in capacity?',
        ],
        [
          'What is beyond the observable universe?',
          'What distinction-patterns exist that cannot propagate to us?',
        ],
        [
          'Will the universe end?',
          'Will the boundary network reach equilibrium or dissolution?',
        ],
      ],
      alignment: ['left', 'left'],
    },
    ...
    {
      type: 'summary',
      title: 'Cosmological Implications Summary',
      variant: 'key-points',
      points: [
        'The cosmic horizon marks the limit of accessible distinctions, not a physical boundary',
        'The Big Bang may represent a phase transition where distinction-making became possible',
        'Cosmic expansion may reflect growth of the boundary network\'s capacity',
        'Dark matter affects the boundary landscape without electromagnetic distinction participation',
        'Dark energy may be the baseline cost of maintaining spacetime boundary structure',
        'The framework reframes cosmological questions in terms of boundary-pattern dynamics',
      ],
    },
  ],
  keyPoints: [
