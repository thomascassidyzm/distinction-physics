...
export const section0_1: Section = {
  id: '0.1',
  ...
  content: [
    ...
    },
    {
      ...
      symbol: '\\mathcal{O}',
      definition:
        'Any system that responds differentially to energy, matter, or information from its environment in a way that changes its state.',
      intuition:
        'If a system can be in different states based on different inputs, it is making distinctions. The capacity for differential response is the capacity for distinction-making.',
      examples: [
    ...
    },
    {
      type: 'heading',
      level: 3,
      content: 'Examples of Passive OLUs',
      id: 'passive-olus',
    },
    {
      type: 'paragraph',
    ...
    },
    {
      ...
      style: 'bullet',
      items: [
        { content: 'Different temperatures produce different mercury column heights' },
        { content: 'The mapping between temperature and position IS a distinction being made' },
        {
          content:
    ...
    },
    {
      type: 'heading',
      level: 2,
      content: 'The Spectrum of OLUs',
      id: 'spectrum-of-olus',
    },
    {
      type: 'paragraph',
      content: 'OLU-ness exists on a spectrum:',
    },
    {
      type: 'list',
      style: 'bullet',
    ...
    },
    {
      ...
      id: 'why-definition-matters',
    },
    {
      type: 'paragraph',
      content: 'This definition has several crucial features:',
    },
    {
      type: 'list',
      style: 'numbered',
