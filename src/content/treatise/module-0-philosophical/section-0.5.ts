...
export const section0_5: Section = {
  ...
  content: [
    ...
    },
    {
      ...
      style: 'bullet',
      items: [
        { content: '**Appearance** = Less stable, lower energy investment, observer-specific boundaries' },
        { content: '**Reality** = More stable, higher energy investment, intersubjectively reliable boundaries' },
      ],
    },
    {
      type: 'paragraph',
      content: 'Consider examples:',
    },
    {
      type: 'paragraph',
      content:
    ...
    },
    {
      ...
      style: 'bullet',
      items: [
        { content: 'Required enormous energy investment to discover (particle accelerators, advanced mathematics)' },
        { content: 'Are stable across many observers and instruments' },
        { content: 'Make accurate predictions across wide ranges of conditions' },
        { content: 'Connect coherently with vast networks of other scientific distinctions' },
      ],
    },
    {
      type: 'paragraph',
    ...
    },
    {
      type: 'heading',
      level: 3,
      content: 'The Continuum of Stability',
    },
    {
      type: 'paragraph',
      content: 'Rather than a binary (appearance/reality), we have a spectrum:',
    },
    {
      type: 'list',
      style: 'numbered',
      items: [
        { content: '**Fleeting appearances** - Low energy, unstable, observer-specific (optical illusions, dreams)' },
        { content: '**Perceptual regularities** - Moderate energy, fairly stable (everyday objects)' },
        { content: '**Scientific knowledge** - High energy, very stable, intersubjectively reliable (atomic structure)' },
        {
          content:
    ...
    },
    {
      type: 'heading',
      level: 3,
      content: 'What About Hallucinations?',
    },
    {
      type: 'paragraph',
      content:
