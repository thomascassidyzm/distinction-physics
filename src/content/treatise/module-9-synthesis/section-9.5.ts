  ...
  content: [
    {
      type: 'heading',
      level: 2,
      content: 'Theoretical Development Needed',
    },
    {
      type: 'paragraph',
    ...
    },
    {
      type: 'heading',
      level: 3,
      content: '2. Formal Axiomatization',
    },
    {
      type: 'paragraph',
      content:
    ...
    },
    {
      type: 'heading',
      level: 3,
      content: '3. Multi-Observer Physics',
    },
    {
      type: 'paragraph',
      content:
    ...
    },
    {
      type: 'heading',
      level: 3,
      content: '4. Cosmological Applications',
    },
    {
      type: 'paragraph',
      content:
    ...
    },
    {
      type: 'heading',
      level: 2,
      content: 'Experimental Programs to Pursue',
    },
    {
      type: 'list',
      style: 'numbered',
      items: [
        {
          content:
            '**Consciousness and energy**: The framework predicts that conscious distinction-making has characteristic energy signatures. Experimental programs combining metabolic neuroimaging with careful consciousness measurements could test these predictions.',
        },
        {
          content:
            '**Quantum cognition**: The framework predicts quantum-like effects in cognitive tasks involving ambiguous distinctions. Psychological experiments using paradigms from quantum cognition research could test these predictions.',
        },
        {
          content:
            '**Observer effects**: The framework predicts systematic observer effects in physical measurements. Careful experiments varying observer characteristics while measuring quantum systems could test these predictions.',
        },
        {
          content:
            '**Thermodynamic bounds**: The framework predicts minimum energy requirements for learning. Experiments measuring metabolic costs of specific learning tasks could test whether these bounds are approached in biological systems.',
        },
        {
          content:
            '**Distinction resolution**: The framework predicts that the quantum-classical transition depends on observer resolution. Experiments manipulating observer resolution (through attention, training, or technological enhancement) could test whether classical behavior emerges with increasing distinction resolution.',
        },
      ],
    },
    {
    ...
    },
    {
      type: 'heading',
      level: 3,
      content: 'Integrated Information Theory',
    },
    {
      type: 'paragraph',
      content:
    ...
    },
    {
      type: 'heading',
      level: 3,
      content: 'Quantum Bayesianism (QBism)',
    },
    {
      type: 'paragraph',
      content:
