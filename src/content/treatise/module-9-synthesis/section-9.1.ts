...
export const section9_1: Section = {
  ...
  subtitle: 'Honest Assessment of What Distinction as Primitive Provides',
  ...
  content: [
    ...
    },
    {
      type: 'heading',
      level: 2,
      content: 'The Transcendental Foundation',
      id: 'transcendental-foundation',
    },
    {
      type: 'paragraph',
      content:
    ...
    },
    {
      type: 'heading',
      level: 2,
      content: 'What Each Module Contributes [With Epistemic Labels]',
    ...
    {
      type: 'theorem',
      id: 'thm-framework-unity',
      label: 'claim',
      name: 'Framework Unity [INTERPRETED]',
      statement:
    ...
    },
    {
      ...
      variant: 'key-points',
      points: [
        'The transcendental priority of distinction-making is the foundational philosophical move, combined here with a specific thermodynamic grounding [DERIVED]',
        'The variational account of acquisition (§4.2) is the framework\'s most concrete and directly testable theoretical move [DERIVED + INTERPRETED]',
        'The framework provides unifying vocabulary across domains [INTERPRETED]',
        ...
        'Conjecture 6.1 (gravity-coherence coupling) is the one concrete framework-native empirical prediction at present',
      ],
    },
  ],
  keyPoints: [
