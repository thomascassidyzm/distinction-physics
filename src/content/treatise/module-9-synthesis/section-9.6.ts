  ...
  content: [
    {
      type: 'heading',
      level: 2,
      content: 'What the Framework Claims',
      id: 'what-the-framework-claims',
    },
    {
      type: 'paragraph',
      content:
    ...
    },
    {
      ...
      style: 'bullet',
      items: [
        { content: 'The structure of **mathematics** as formalization of distinction-making' },
        { content: '**Consciousness** as self-referential distinction-making' },
        { content: '**Quantum mechanics** as the physics of finite-energy observation' },
        { content: '**Spacetime** as distinction-geometry (speculatively)' },
        { content: '**Thermodynamics** as the statistical mechanics of distinction ensembles' },
        {
          content:
