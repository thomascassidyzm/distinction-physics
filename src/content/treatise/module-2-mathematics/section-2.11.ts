...
export const section2_11: Section = {
  ...
  content: [
    ...
    },
    {
      type: 'heading',
      level: 2,
      content: 'Mathematics and the Broader Framework',
      id: 'broader-framework',
    },
    {
      type: 'paragraph',
      content:
    ...
    {
      type: 'table',
      id: 'table-mathematics-emergence',
      caption: 'Summary of mathematical structures emerging from distinction',
      headers: ['Mathematical Domain', 'Distinction Origin', 'Key Insight'],
      rows: [
