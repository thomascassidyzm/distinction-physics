...
export const section5_8: Section = {
  ...
  content: [
    ...
    {
      type: 'math',
      latex: '\\lim_{\\hbar \\to 0} P(\\phi) \\to \\text{classical behavior}',
      display: 'block',
      label: 'eq:classical-limit',
      description: 'The classical limit as effective Planck constant approaches zero',
    },
    {
      type: 'paragraph',
      content:
