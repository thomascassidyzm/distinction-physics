...
export const section5_1: Section = {
  ...
  keyPoints: [
    'Quantum mechanics is interpreted through two axioms: distinctions cost energy and OLUs have finite energy',
    ...
    'The mathematical structure of quantum mechanics (Hilbert spaces, complex amplitudes) is imported, not derived',
    'This is interpretation, not derivation - quantum mechanics is conceptually coherent with the axioms but not logically generated by them',
  ],
};
